...
// image default alt
if( !function_exists( 'artraz_img_default_alt' ) ){
	function artraz_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'artraz_img_tag' ) ){
	function artraz_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = artraz_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'artraz_anchor_tag' ) ){
	function artraz_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'artraz_heading_tag' ) ){
	function artraz_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'artraz_paragraph_tag' ) ){
	function artraz_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'artraz_span_tag' ) ){
	function artraz_span_tag( array $args ){
